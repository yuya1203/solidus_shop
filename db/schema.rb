...
ActiveRecord::Schema.define(version: 2019_07_05_043929) do
  ...
  create_table "spree_blog_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.text "body"
    t.string "permalink"
